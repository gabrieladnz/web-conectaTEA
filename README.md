...
```
cd existing_repo
git remote add origin https://gitlab.com/Zumbikeller/conectatea.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Zumbikeller/conectatea/-/settings/integrations)
